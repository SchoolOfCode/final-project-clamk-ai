  ...
  return (
    <div className="flex justify-center items-center mt-16 pb-18 p-8 relative">
      {isLoading ? (
        ...
        <div className="bg-green-100 py-4 px-6 rounded-xl shadow-lg inline-flex items-center justify-center mx-auto">
          <blockquote className="text-xl text-emerald-900 font-semibold italic mr-4">
            {quote}
          </blockquote>
          <p className="text-lg text-semibold text-emerald-900 whitespace-nowrap">
            - {author}
          </p>
        </div>
      )}
